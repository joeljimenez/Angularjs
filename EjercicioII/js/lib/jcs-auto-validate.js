...
angular.autoValidate.errorMessages['default'] = {
  ...
  minlength: 'Porfavor introduzca al menos {0} characters',
  maxlength: 'Has ingresado más del máximo {0} characters',
  min: 'Porfavor Ingrese un numero minino de {0}',
  max: 'Porfavor Ingrese un numero Maximo de {0}',
  required: 'Este campo es Requerido',
  date: 'Porfavor Ingrese una Fecha Valida',
  pattern: 'Please ensure the entered information adheres to this pattern {0}',
  number: 'Porfavor Ingrese una Numero Valido',
  url: 'Porfavor Ingrese un url con este formato http(s)://www.google.com'
};
